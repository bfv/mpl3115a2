...
import { CtrlReg1 } from './registers';
...
export class MPL3115A2 {
    ...
    init() {
        this.bus.writeByteSync(this.deviceAddress, registers.CTRL_REG1, CtrlReg1.OSR128);
        this.bus.writeByteSync(this.deviceAddress, registers.PT_DATA_CFG, 0b00000111);
        this.bus.writeByteSync(this.deviceAddress, registers.CTRL_REG1, CtrlReg1.OSR128 | CtrlReg1.SBYB);
    }
